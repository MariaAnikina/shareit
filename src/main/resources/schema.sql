...
-- CREATE TYPE relevant_temperature_interval AS ENUM ('VERY_COLD', 'COLD', 'NEUTRAL', 'WARM', 'VERY_WARM', 'ALWAYS_RELEVANT');
...
CREATE TABLE IF NOT EXISTS items (
    ...
    request_id BIGINT,
    relevant_temperature_interval VARCHAR(128) NOT NULL,
    city VARCHAR(256) NOT NULL,
...
CREATE TABLE IF NOT EXISTS item_requests (
    ...
    CONSTRAINT fk_item_request_to_users FOREIGN KEY(requestor_id) REFERENCES users(user_id) ON DELETE CASCADE
    );
